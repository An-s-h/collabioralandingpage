...
export default function FeaturesCarousel() {
  ...
  const renderVisual = (visual: string, colorClasses: any) => {
    switch (visual) {
      case "dashboard":
        return (
      ...
      case "reports":
        return (
          <div className="space-y-2 w-full">
            <button
              className="w-full py-1.5 px-3 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5  text-white"
              style={{
                background: ``,
              }}
            >
  ...
  return (
    <section className="relative px-4 sm:px-5 overflow-hidden pb-8 pt-4">
